...
int main()
{
	...
	const int triangleAmount = 21;
	float pi2 = 3.14159265358979323846 * 2;

	const int len = triangleAmount * 3 + 3;
	float vertices[len];
	vertices[0] = 0.0;
	vertices[1] = 0.0;
	vertices[2] = 0.0f;
	...
	for (int i = 0; i < triangleAmount; i++) {
		...
		vertices[pos + 0] = (0.3 * cos(i *  pi2 / (triangleAmount - 1)));
		vertices[pos + 1] = (0.3 * sin(i *  pi2 / (triangleAmount - 1)));
		vertices[pos + 2] = 0.0f;
	}
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLE_FAN, 0, len); // set the count to 6 since we're drawing 6 vertices now (2 triangles); not 3!
